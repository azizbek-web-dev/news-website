            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-xl mb-8">
                    <div class="px-6 py-12 text-center">
                        ...
                        <h1 class="text-4xl font-bold text-white mb-4">About our news website</h1>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-8">
                            <div class="p-8">
                                <div class="flex items-center mb-6">
                                    ...
                                    <h2 class="text-2xl font-semibold text-gray-800">What we cover</h2>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="bg-blue-50 p-6 rounded-lg hover:shadow-md transition-shadow duration-300">
                                        <div class="flex items-center mb-4">
                                            ...
                                            <h3 class="text-lg font-semibold text-blue-800">Politics</h3>
                                        </div>
                                    ...
                                    <div class="bg-green-50 p-6 rounded-lg hover:shadow-md transition-shadow duration-300">
                                        <div class="flex items-center mb-4">
                                            ...
                                            <h3 class="text-lg font-semibold text-green-800">Sports</h3>
                                        </div>
                                        <p class="text-green-700">
                                            Get the latest updates on your favorite sports, athletes, and major sporting events.
                                        </p>
                                    </div>
                                    <div class="bg-purple-50 p-6 rounded-lg hover:shadow-md transition-shadow duration-300">
                                        <div class="flex items-center mb-4">
                                            ...
                                            <h3 class="text-lg font-semibold text-purple-800">Technology</h3>
                                        </div>
                                        <p class="text-purple-700">
                                            Discover the latest innovations, tech trends, and digital developments.
                                        </p>
                                    </div>
                                    <div class="bg-yellow-50 p-6 rounded-lg hover:shadow-md transition-shadow duration-300">
                                        <div class="flex items-center mb-4">
                                            ...
                                            <h3 class="text-lg font-semibold text-yellow-800">Entertainment</h3>
                                        </div>
                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            <h4 class="font-semibold text-gray-800">Accuracy</h4>
                                            <p class="text-sm text-gray-600">We verify all information before publishing</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <div class="bg-green-100 rounded-full p-1 mr-3 mt-1">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600">We maintain the highest ethical standards</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <div class="bg-green-100 rounded-full p-1 mr-3 mt-1">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600">We are open about our sources and methods</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <div class="bg-green-100 rounded-full p-1 mr-3 mt-1">
                                        ...
                                        <div>
                                            <h4 class="font-semibold text-gray-800">Independence</h4>
                                            <p class="text-sm text-gray-600">Free from political or commercial influence</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <div class="bg-green-100 rounded-full p-1 mr-3 mt-1">
                                        ...
                                        <div>
                                            <h4 class="font-semibold text-gray-800">Diversity</h4>
                                            <p class="text-sm text-gray-600">We represent diverse voices and perspectives</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-gray-600">info@newssite.com</span>
                                    </div>
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <span class="text-gray-600">123 News Street, Media City, MC 12345</span>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="w-5 h-5 text-gray-400 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        <span class="text-gray-600">Monday - Friday, 9:00 AM - 6:00 PM</span>
                                    </div>
                                </div>
                            </div>
                        </div>
