        ...
        <div class="py-6 sm:py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <h2 class="text-2xl font-bold text-gray-900 mb-6 text-center sm:text-left">Get in touch</h2>
                            ...
                            <div class="space-y-6 text-center sm:text-left">
                                ...
                                <div class="flex items-start justify-center sm:justify-start">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <p class="text-gray-600">123 News Street</p>
                                        <p class="text-gray-600">Media City, MC 12345</p>
