    ...
    public function run(): void
    {
        ...
        $posts = [
            ...
            [
                ...
                'content' => 'A comprehensive healthcare reform bill has passed the Senate with bipartisan support, promising to expand coverage to millions of uninsured citizens. The legislation includes provisions for mental health services, prescription drug price controls, and rural healthcare access improvements.',
                'category' => 'Politics'
            ],
            [
